...
public class AlgorithmExtension {
    ...
    public static final Algorithm secondDegreeEquation = new AlgorithmParser(0, 1, false, "2nd degree equations", new Date(0), new AlgorithmIcon("square", "alizarin"), "print_text \"Updating from server...\"").execute();
